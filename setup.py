...
import p2pool.yrmix.networks
extra_includes.extend('p2pool.yrmix.networks.' + x for x in p2pool.yrmix.networks.nets)
...
dir_name = 'p2pool_yrmix_win' + win + '_' + version
