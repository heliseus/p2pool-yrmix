...
from p2pool.yrmix import data as yrmix_data, getwork
...
class StratumRPCMiningProvider(object):
    ...
    def _send_work(self):
        ...
        self.other.svc_mining.rpc_set_difficulty(yrmix_data.target_to_difficulty(x['share_target'])).addErrback(lambda err: None)
    ...
    def rpc_submit(self, worker_name, job_id, extranonce2, ntime, nonce):
        ...
        header = dict(
            ...
            merkle_root=yrmix_data.check_merkle_link(yrmix_data.hash256(new_packed_gentx), x['merkle_link']),
