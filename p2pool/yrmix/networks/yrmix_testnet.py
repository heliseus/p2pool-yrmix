...
BLOCK_EXPLORER_URL_PREFIX = 'https://test.explorer.yrmix.org/block/'
ADDRESS_EXPLORER_URL_PREFIX = 'https://test.explorer.yrmix.org/address/'
TX_EXPLORER_URL_PREFIX = 'https://test.explorer.yrmix.org/tx/'
